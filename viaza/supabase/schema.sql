-- ============================================================
-- DEPRECADO (2026-03-13)
--
-- Fuente de verdad:
--   `supabase/schema_viaza.sql`
--
-- Motivo:
--   Evitar duplicidad de schemas. Este archivo se deja de forma
--   INTENCIONALMENTE NO EJECUTABLE para prevenir que alguien lo aplique
--   por error en el SQL Editor de Supabase.
-- ============================================================

do $$
begin
  raise exception
    'DEPRECATED: Do not run supabase/schema.sql. Use supabase/schema_viaza.sql as the single source of truth.';
end $$;
